// Íconos SVG inline (stroke), estilo del mockup. Sin dependencias de librerías de íconos.
...
export function IconBookOpen({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 6.5C10.5 5 8 4 4 4v14c4 0 6.5 1 8 2.5 1.5-1.5 4-2.5 8-2.5V4c-4 0-6.5 1-8 2.5Z" />
      <path d="M12 6.5V21" />
    </svg>
  )
}
