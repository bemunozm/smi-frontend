    ...
    <>
      {isSidebarOpen ? (
        <button
          ...
          className="fixed inset-y-0 inset-e-0 inset-s-64 z-30 bg-black/40 lg:hidden"
      ...
      <aside
        className={`fixed inset-y-0 inset-s-0 z-40 flex w-64 shrink-0 flex-col border-e border-border bg-surface-secondary transition-transform lg:static lg:translate-x-0 ${
